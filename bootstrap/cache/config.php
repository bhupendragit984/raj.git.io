<?php return array (
  ...
  array (
    ...
    'fallback_locale' => 'en',
    'locales' => NULL,
    'key' => 'base64:BBNHRrYZjpfla5lFWpCNXZdNCaS7SrsipkCJoUUn+1Q=',
    'cipher' => 'AES-256-CBC',
    'providers' => 
    array (
  ...
  array (
    ...
    'files' => '/Applications/MAMP/htdocs/laravel-boilerplate/routes/breadcrumbs.php',
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'file',
        'path' => '/Applications/MAMP/htdocs/laravel-boilerplate/storage/framework/cache/data',
      ),
      'memcached' => 
      array (
        'driver' => 'memcached',
  ...
  array (
    ...
    array (
      'enabled' => true,
      'driver' => 'file',
      'path' => '/Applications/MAMP/htdocs/laravel-boilerplate/storage/debugbar',
      'connection' => NULL,
      'provider' => '',
    ),
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'local',
        'root' => '/Applications/MAMP/htdocs/laravel-boilerplate/storage/app',
      ),
      'public' => 
      array (
        'driver' => 'local',
        'root' => '/Applications/MAMP/htdocs/laravel-boilerplate/storage/app/public',
  ...
  array (
    ...
    'helper_files' => 
    array (
      0 => '/Applications/MAMP/htdocs/laravel-boilerplate/vendor/laravel/framework/src/Illuminate/Support/helpers.php',
    ),
    'model_locations' => 
    array (
      0 => 'app',
  ...
  'log-viewer' => 
  array (
    'storage-path' => '/Applications/MAMP/htdocs/laravel-boilerplate/storage/logs',
    'pattern' => 
    array (
      'prefix' => 'laravel-',
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'single',
        'path' => '/Applications/MAMP/htdocs/laravel-boilerplate/storage/logs/laravel.log',
        'level' => 'debug',
      ),
      'daily' => 
      array (
  ...
  array (
    ...
    array (
      ...
      'paths' => 
      array (
        0 => '/Applications/MAMP/htdocs/laravel-boilerplate/resources/views/vendor/mail',
      ),
    ),
  ),
  'meta' => 
  array (
    ...
    array (
      ...
      array (
        ...
        'description' => NULL,
        'subject' => NULL,
        'identifier' => 'Laravel Boilerplate',
        'creator' => NULL,
        'publisher' => NULL,
        'rights_holder' => NULL,
        'type' => 'Text',
    ...
    'title_suffix' => '| Laravel Boilerplate',
  ),
  'protection' => 
  array (
    'connection' => 
  ...
  array (
    ...
    'encrypt' => false,
    'files' => '/Applications/MAMP/htdocs/laravel-boilerplate/storage/framework/sessions',
    'connection' => NULL,
    'table' => 'sessions',
    'store' => NULL,
    'lottery' => 
  ...
  array (
    'paths' => 
    array (
      0 => '/Applications/MAMP/htdocs/laravel-boilerplate/resources/views',
    ),
    'compiled' => '/Applications/MAMP/htdocs/laravel-boilerplate/storage/framework/views',
  ),
  'tinker' => 
  array (
    'commands' => 
